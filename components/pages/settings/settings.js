...
export default class Settings extends React.Component{
    ...
    renderConsignment(cons){
        return cons.map(e => {
            return <div className="dash-cardbox-map google_map_shadow" draggable onDragStart={(ev)=>this.onDragStart(ev,e.name)}>
    ...
    renderVehicles(vehicles){
        return vehicles.map(e => {
            return <div className="dash-cardbox-map google_map_shadow" onDragOver={(ev)=>this.onDragOver(ev)}
